...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        W2 = weight_scale * np.random.randn(int(num_filters*HP*WP), hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        l1,c1 = conv_lrelu_pool_forward(X, W1, b1, conv_param, lrelu_param, pool_param)
        l2,c2 = affine_lrelu_forward(l1, W2, b2, lrelu_param)
        scores, c3 = affine_forward(l2, W3, b3)
        ...
        # Backward
        dx3, dw3, db3  = affine_backward(gradient,c3)
        dx2, dw2, db2 = affine_lrelu_backward(dx3, (c3,c2))
        dx1, dw1, db1 = conv_lrelu_pool_backward(dx2, c1)
